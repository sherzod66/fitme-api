...
router.put(
  "/add-workout-plan-by-students/:id",
  validateIdParam,
  validate(addPlanByStudentSchema),
  controller.addWorkoutPlanByStudent
);

router.put(
  "/add-nutrition-plan-by-students/:id",
  validateIdParam,
  validate(addPlanByStudentSchema),
  controller.addNutritionPlanByStudents
);
